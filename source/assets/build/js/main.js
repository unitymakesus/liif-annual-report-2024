...
/***/ "./source/_assets/js/init/tabs.js":
/*!****************************************!*\
  !*** ./source/_assets/js/init/tabs.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _init_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./init/tabs */ "./source/_assets/js/init/tabs.js");
...
/* harmony import */ var _util_prefersReducedMotion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./util/prefersReducedMotion */ "./source/_assets/js/util/prefersReducedMotion.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var reduceMotion = (0,_util_prefersReducedMotion__WEBPACK_IMPORTED_MODULE_4__["default"])();

  // Lazyload Images
  var myLazyLoad = new (vanilla_lazyload__WEBPACK_IMPORTED_MODULE_5___default())();

  // Tabs
  var tablists = document.querySelectorAll('.tabs');
  if (tablists.length) {
    tablists.forEach(function (tablist) {
      new _init_tabs__WEBPACK_IMPORTED_MODULE_1__["default"](tablist);
    });
  }

  // Splide
  var splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_2__["default"]('.splide', {
    drag: false,
    type: 'fade',
    pagination: false,
    rewind: true
  ...
  if (reduceMotion === false) {
    var countUp = new countup_js__WEBPACK_IMPORTED_MODULE_0__.CountUp('target', 61, {
      enableScrollSpy: true,
      duration: 1.5,
      scrollSpyOnce: true
    });
    var goalProgressBar = document.getElementById('bar');
...
/***/ "./source/_assets/js/util/prefersReducedMotion.js":
/*!********************************************************!*\
  !*** ./source/_assets/js/util/prefersReducedMotion.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (prefersReducedMotion);
